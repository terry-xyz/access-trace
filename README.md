...
Goals are limited to keyboard assessment of the controlled local demo. Remote URLs, non-keyboard interaction modes, visual-only checks such as color contrast, full-conformance requests, and requests to override safeguards or run code are rejected before a sample report is shown.
